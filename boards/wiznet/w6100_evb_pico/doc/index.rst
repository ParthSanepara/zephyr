...
.. figure:: img/w6100_evb_pico_side.png
     :align: center
     :alt: W6100 Evaluation Board

     Wiznet W6100_EVB_PICO evaluation board (Image courtesy of Wiznet)

Supported Features
==================

The w6100_evb_pico board configuration supports the following
hardware features:
...
Pi Pico, the blinky example works as intended. The W6100 is routed to the SPI0
...
You can Flash the w6100_evb_pico with a SEGGER JLink debug probe as described in
...
The Raspberry Pi Pico, and thus the W6100 Evaluation Board, has an SWD
